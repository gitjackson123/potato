 ...
 */
public class PotatoJsonRpcUserControl extends JsonRpcUserControl {
  ...
  private static final Logger log = LoggerFactory.getLogger(PotatoJsonRpcUserControl.class);
  ...
  public PotatoJsonRpcUserControl(NotificationRoomManager roomManager) {
    super(roomManager);
  }
