...
public class RoomJsonRpcHandler extends DefaultJsonRpcHandler<JsonObject> {
  ...
  public final void handleRequest(Transaction transaction, Request<JsonObject> request)
    ...
    switch (request.getMethod()) {
      case ProtocolElements.CALLMEET_METHOD :
        userControl.callMeet(transaction, request, participantRequest);
        break;
      case ProtocolElements.JOINMEET_METHOD :
        userControl.joinMeet(transaction, request, participantRequest);
        break;
