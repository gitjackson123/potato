...
public class ProtocolElements {
  ...
  public static final String CALLMEET_METHOD = "callMeet";
  public static final String CALLMEET_CALLERID = "callerId";
  public static final String CALLMEET_CALLEDLIST = "calledList";
  public static final String CALLMEET_CALLTYPE = "callType";

  public static final String JOINMEET_METHOD = "joinMeet";
  public static final String JOINMEET_CALLERID = "calledId";
